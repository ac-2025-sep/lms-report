...
urlpatterns = [
    ...
    path("progress_overview_test_1", views.progress_overview_test_1, name="progress_overview_test_1"),
    ...
    path("assets/intelligence-dashboard.css", views.intelligence_dashboard_css, name="intelligence_dashboard_css"),
    path("assets/intelligence-dashboard.js", views.intelligence_dashboard_js, name="intelligence_dashboard_js"),
